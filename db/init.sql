...
(1, 'Coffre au mot de passe', null, 'coffre.jpg', 18, False, 2, True, ST_SetSRID(ST_MakePoint(2.3376682017145742, 48.860839625570065), 4326)),
(2, 'Pierre de l''Espace', 'La prochaine pierre se trouve à un des points le plus de Paris.', 'pierre_espace.jpg', 18, False, 3, False, ST_SetSRID(ST_MakePoint(2.3376682017145742, 48.860839625570065), 4326)),
...
(5, 'Coffre qui necessite pierres', null, 'coffre.jpg', 18, False, 6, True, ST_SetSRID(ST_MakePoint(2.298507655860395, 48.85578060681327), 4326)),
(6, 'Code à 4 chiffres', 'Il y a un autre coffre, à deux pas d''ici, sous le symbole de Paris... Peut-être que ce code pourra t''être utile...', 'code_4_chiffres.jpg', 18, False, 7, False, ST_SetSRID(ST_MakePoint(2.298507655860395, 48.85578060681327), 4326)),
(7, 'Coffre qui necessite code à 4 chiffres', null, 'coffre.jpg', 18, False, 8, True, ST_SetSRID(ST_MakePoint(2.294435404975033, 48.85847053148979), 4326)),
