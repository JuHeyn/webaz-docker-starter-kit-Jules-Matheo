...
(1, 'Coffre au mot de passe', 'coffre.jpg', 18, False, 2, '0_Le Louvre;Louvre', ST_SetSRID(ST_MakePoint(2.3376682017145742, 48.860839625570065), 4326)),
...
(5, 'Coffre qui necessite pierres', 'coffre.jpg', 18, False, 6, "1_0;2;3;4", ST_SetSRID(ST_MakePoint(2.298507655860395, 48.85578060681327), 4326)),
(6, 'Code a 4 chiffres', 'code_4_chiffres.jpg', 18, False, 7, null, ST_SetSRID(ST_MakePoint(2.298507655860395, 48.85578060681327), 4326)),
(7, 'Coffre qui necessite code a 4 chiffres', 'coffre.jpg', 18, False, 8, '0_0369', ST_SetSRID(ST_MakePoint(2.294435404975033, 48.85847053148979), 4326)),
